/* eslint-disable */
import type { Prisma, Recipe, Image, Category, Ingredient, Account, Session, User, VerificationToken } from "./prisma/client.js";
...
export default interface PrismaTypes {
    Recipe: {
        ...
        Create: {};
        Update: {};
        RelationName: "category" | "ingredients" | "author" | "favoritedBy" | "image";
